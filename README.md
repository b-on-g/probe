...
- **Пропуск пропуску не равен.** «Chrome не найден» это `$bog_probe_skip`, и в объявленном окружении он красный. Свои пропуски проверки — «мастера нет», «подпись снята на другой машине» — это ДРУГИЕ строки, они передаются в `$bog_probe_done` как успешные и остаются зелёными. Сводить их в одно значение нельзя: тогда отсутствие браузера снова начнёт сходить за успех.
